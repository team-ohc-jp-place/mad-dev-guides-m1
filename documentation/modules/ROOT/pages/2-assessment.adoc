...
When you see *Do you want to create a dedicated assessment for this application and override the inherited archetype assessment(s)?* message, click on `Override` to continue the assessment.
